...
function ResetPassword() {
    ...
    const handleClick = async (event) => {
        ...
        try {
            ...
            const responseEmail = response.data.email;  // Renamed variable to avoid conflict

            if (responseEmail) {
                alert(`Password reset link sent to ${responseEmail}`);
            } else {
                alert("Email doesn't exist with us.");
            }
        } catch (error) {
                                    ...
                                    <div className="row gy-3 overflow-hidden">
                                        ...
                                        <div className="col-12">
                                            <div className="d-grid">
                                                <button className="btn bsb-btn-xl btn-primary" type="submit">Send Reset Link</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                            <a href="#" className="link-secondary text-decoration-none" onClick={() => navigate('/login')}>Login</a>
                                            <a href="#" className="link-secondary text-decoration-none" onClick={() => navigate('/signup')}>Sign Up</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
